...
pub fn parse_markdown_impl<T: fmt::Display>(markdown: T) -> String {
...
pub fn parse_markdown<T: fmt::Display>(
    ...
    Ok(parse_markdown_impl(markdown))
}

use chrono::{DateTime, Utc};

pub fn pretty_date_impl(date_time: &DateTime<Utc>) -> String {
    format!("{}", date_time.format("%e %B %Y"))
}

// This filter does not have extra arguments
#[askama::filter_fn]
pub fn pretty_date(date_time: &DateTime<Utc>, _: &dyn askama::Values) -> ::askama::Result<String> {
    Ok(pretty_date_impl(date_time))
}

const FORBIDDEN_LINES: [&str; 5] = [" ", "#", "-", "!", "<"];

pub fn truncate_md_impl(body: &str, rows: usize) -> String {
